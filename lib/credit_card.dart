              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Container(
                    ...
                    child: Text(orgName, style: cardSharingConstants.kBankNameStyle),
                  ),
                  SizedBox(height: 18 * heightFactor),
                  Container(
                    padding: EdgeInsets.only(left: 13),
                    child: Text('Available limit', style: cardSharingConstants.kBodyStyle),
                  ),
                  Container(
                    padding: EdgeInsets.only(left: 13),
                    child: RichText(
                  ...
                  Container(
                    padding: EdgeInsets.only(left: 13),
                    child: Text('Spent this month', style: cardSharingConstants.kBodyStyle),
                  ),
                  Container(
                    padding: EdgeInsets.only(left: 13),
                    child: RichText(
