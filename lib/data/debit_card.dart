...
class DebitCard extends StatelessWidget {
  ...
  const DebitCard({Key key, this.heightFactor, this.widthFactor, this.textScaleFactor, this.balance, this.spentThisMonth, this.cardColor, this.orgName, this.accountNumber}) : super(key: key);
